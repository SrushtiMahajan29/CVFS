...
void DisplayHelp()
{
    ...
    printf("closeall : To close all openend files\n");
...
void CreateDILB()
{
    ...
    {   //Singly Linked List
        ...
        //Initialize all members of inode structure
        newn->LinkCount = 0;
...
/*
    ...
    */
    ...
    int Lseek(int fd,int size, int from)
    {
        if((fd<0)|| (from > 2))
            return -1;
    ...
    while(1)
    {
        ...
        else if(count==3)
        {
            if(strcmp(command[0],"create")==0)
            {
                ...
                if(ret>=0)
                {
                    printf("File is successfully created wih file descriptor: %d\n",ret);
                }
                if(ret==-1)
                {
                    printf("ERROR: Incorrect parameter\n");
            ...
            else if(strcmp(command[0],"open")==0)
            {
                ...
                if(ret>=0)
                {
                    printf("File is successfully opened wih file descriptor: %d\n",ret);
                }
                if(ret==-1)
                {
                    printf("ERROR: Incorrect parameter\n");
    ...
    else if(count==4)
        {
            if(strcmp(command[0],"lseek")==0)
            {
                ...
                ret=Lseek(fd,atoi(command[2]),atoi(command[3]));

                if(ret==-1)
                {
                    printf("ERROR:Unable to perform lseeks\n");
                }  
            }
            else
            {
